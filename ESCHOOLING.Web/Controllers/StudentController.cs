...
namespace ESCHOOLING.Web.Controllers
{
    public class StudentController : Controller
    {
        ...
        public StudentController(ILogger<TeacherController> logger, IApplicatioUser applicatioUserService, IConfiguration config, IWebHostEnvironment webHostEnvironment)
        {
            _logger = logger;
